 ...
 * @date 2020/3/9 0:08
 */
public class LoginTokenAdapter extends AbstractAdapter {

    protected LoginTokenAdapter() {
        super();
    }

    protected LoginTokenAdapter(LoginService loginService) {
        super(loginService);
    }

    @Override
    public boolean support(Object object) {
        return object instanceof LoginTokenAdapter;
    }
